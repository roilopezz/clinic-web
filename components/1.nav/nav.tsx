        ...
        <nav className="nav absolute top-3 mobile:top-10 rounded-[12px] flex justify-center bg-center items-center w-8/12 mobile:w-11/12 h-navHight flex-wrap bg-white">
          ...
          {collapse ? (
            <div
              className={`${
                locale === "en"
                  ? "navBottomRadius p-5 bg-white w-full flex-grow lg:flex lg:items-center lg:w-auto lg:text-left sm:text-left"
                  : "navBottomRadius p-5 bg-white w-full flex-grow lg:flex lg:items-center lg:w-auto lg:text-right sm:text-right"
              }`}
            >
              ...
              <div className="block gap-4 flex justify-center">
                <Image
